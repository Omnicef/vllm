...
# local diagnostics (NOT FOR UPSTREAM): GLM5_TRACE_DSA=<layer idx> hashes and
# dumps every stage of the indexer for that layer, GLM5_SORT_TOPK=1 sorts the
# selected pools. This is the indexer GLM-5.3 uses; the identically-named one in
# v1/attention/ops/rocm_aiter_mla_sparse.py is the DeepSeek aiter path and is
# never called here, which is why hooks placed there produced nothing.
_GLM5_DSA_RUN = [0]
